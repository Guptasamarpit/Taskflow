...
public class ProjectController {
    ...
    public ProjectController(ProjectService p, TaskService t) {
        this.p = p;
        this.t = t;
    }

    @GetMapping
    List<ProjectResponse> all(Authentication a) {
        return p.all(a.getName());
    }
    ...
    List<TaskResponse> tasks(Authentication a, @PathVariable Long pid) {
        return t.all(a.getName(), pid);
    }
